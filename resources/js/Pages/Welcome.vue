...
<template>
    ...
    <AppLayout title="Profile">
        <div
            class="banner-area mt-12 md:mt-28 relative z-1 before:absolute before:left-0 before:right-0 before:bottom-0 before:bg-[#fbfbfb] before:h-[180px] md:before:h-[300px] before:-z-1">
            <div class="container">
                <div class="banner-content text-center mx-auto max-w-5xl">
                    <h1 class="font-black text-black-color text-2xl lg:text-3xl xl:text-6xl mb-4 md:mb-15">
                        Always Build Better Product With Togy</h1>
                    <p class="text-optional-color text-sm md:text-base lg:text-lg mb-8 lg:ml-auto lg:mr-auto lg:max-w-[790px] md:leading-8 leading-7">
                    ...
                    <a href="profile-authentication.html"
                       class="inline-block mt-0 md:mt-5 lg:mt-10 font-semibold text-base md:text-lg lg:text-xl rounded-md text-white py-4 px-6 bg-secondary-gradient-color shadow-custom-box-shadow hover:shadow-secondary-btn ease-in duration-300">Sign
                        Up For Free</a>
                    <span
                        class="block text-gray-400 mt-8 text-base">Avail 30 Days Free Trial</span>
                </div>
                <div
                    class="banner-image text-center mt-20 rounded-xl relative xl:ml-auto xl:mr-auto xl:max-w-[1094px]">
                    <img src="assets/img/banner/banner-img2.jpg"
                         class="inline-block rounded-md md:rounded-xl wow animate__animated animate__fadeInUp"
                         data-wow-delay=".1s" alt="banner-image">
                    <img src="assets/img/shape/best.png"
                         class="absolute left-[-85px] top-[-140px] hidden 2xl:inline animate-custom-movebounce"
                         alt="image">
                    <img src="assets/img/shape/easy.png"
