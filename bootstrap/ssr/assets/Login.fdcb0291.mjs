import { computed, unref, withCtx, createVNode, createTextVNode, openBlock, createBlock, toDisplayString, createCommentVNode, withModifiers, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    computed(() => usePage().props.value.env);
    const submit = () => {
      form.transform((data) => ({
        ...data,
